    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '승인대기'), ('active', '활성'), ('paused', '정지'), ('cancelled', '해지')], default='pending', max_length=10, verbose_name='상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200, verbose_name='제목')),
                ('category', models.CharField(choices=[('CrossFit', 'CrossFit'), ('주짓수', '주짓수'), ('복싱', '복싱'), ('MMA', 'MMA'), ('요가', '요가'), ('PT', 'PT'), ('기타', '기타')], default='CrossFit', max_length=50, verbose_name='종목')),
                ('level', models.CharField(choices=[('초급', '초급'), ('중급', '중급'), ('고급', '고급'), ('전체', '전체')], default='전체', max_length=20, verbose_name='레벨')),
                ...
                ('rounds', models.PositiveIntegerField(blank=True, null=True, verbose_name='라운드 수')),
                ('time_cap', models.PositiveIntegerField(blank=True, null=True, verbose_name='타임캡 (분)')),
                ('exercises', models.JSONField(blank=True, default=list, verbose_name='운동 목록')),
